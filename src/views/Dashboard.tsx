                    ...
                    <div style={{ flex: 1, width: '100%', minHeight: 0 }}>
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={monthlyData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                ...
                                <Tooltip cursor={{ fill: 'var(--bg-sec)' }} contentStyle={{ borderRadius: '12px', border: '1px solid var(--border-color)', background: 'var(--card-bg)' }} formatter={(value: any, name: string) => [`$${Number(value).toLocaleString('en-US', { minimumFractionDigits: 2 })}`, name]} />
                                <Legend />
